...
interface API {
    ...
    @GET("api.edamam.com/api/nutrition-data?app_id=a9a8f7ce&app_key=8baaf4365a5146edf16fe95080af67ad&nutrition-type=cooking&ingr=%22%22")

    fun getNutrition():Single<List<IndividualNutritionFact>>

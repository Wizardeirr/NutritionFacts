...
interface NutritionAPI {
    ...
    @GET("utrition-data?app_id=a9a8f7ce&app_key=8baaf4365a5146edf16fe95080af67ad&nutrition-type=logging&ingr=")
//https://api.edamam.com/api/n
    fun getNutrition(@Query("ingr")searchQuery:String,):Single<nutrition>
